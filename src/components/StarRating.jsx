...
// contenedor individual de una estrella
...
* @param {string} props.color - Color de las estrellas ( '#fcc419').
* @param {number} props.size - Tamaño de las estrellas en píxeles (30px).
* @param {number} props.defaultRating - Calificación inicial seleccionada (0).
...
export default function StarRating({
    ...
    // estilos de texto de califación
    const textStyle = {
        lineHeight: "1",
        margin: "0",
        color,
    ...
    // almacenar calificación seleccionada
    ...
    */
    ...
    function handleRating(rating) {
        setRating(rating);
        onSetRating?.(rating); // callback si está definida
    }
